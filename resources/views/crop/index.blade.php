...
<h4 class="page-title">Crop Categories</h4>
@isset($crops)
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-flex justify-content-between align-items-center">
                        <h3 class="mb-0">Available Crops Categories</h3>
                        <a href="{{ route('crops.create') }}" class="btn btn-sm btn-primary text-white"><i class="fas fa-plus"></i></a>
                    </div>
                </div>
                <div class="card-body">
                    @if(count($crops) != 0)
                            ...
                            <tbody>
                                @foreach ( $crops as $crop )
                                    <tr>
                                        ...
                                        <td><a href="{{ route('crops.edit', $crop->id) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a></td>
                                        <td>
